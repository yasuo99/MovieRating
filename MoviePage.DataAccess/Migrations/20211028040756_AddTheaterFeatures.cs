...
{
    public partial class AddTheaterFeatures : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Votes", x => new { x.MovieId, x.AccountId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WatchUrls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WatchUrls_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TheaterBranch", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TheaterBranch_Theater_TheaterId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TheaterBranchId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MovieId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieSchedule_TheaterBranch_TheaterBranchId",
                        column: x => x.TheaterBranchId,
                        principalTable: "TheaterBranch",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    XNum = table.Column<int>(type: "int", nullable: false),
                    YNum = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Seat_TheaterBranch_TheaterBranchId",
                        column: x => x.TheaterBranchId,
                        principalTable: "TheaterBranch",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SeatBooking_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SeatBooking_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SeatBooking_Seat_SeatId",
                        column: x => x.SeatId,
                        principalTable: "Seat",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieSchedule_TheaterBranchId",
                table: "MovieSchedule",
                column: "TheaterBranchId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Seat_TheaterBranchId",
                table: "Seat",
                column: "TheaterBranchId");

            migrationBuilder.CreateIndex(
                name: "IX_SeatBooking_MovieId",
                table: "SeatBooking",
                column: "MovieId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SeatBooking_UserId",
                table: "SeatBooking",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TheaterBranch_TheaterId",
                table: "TheaterBranch",
                column: "TheaterId");
